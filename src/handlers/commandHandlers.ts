...
export async function handleNwcInfo(ctx:CommandContext<MyContext>){
    await ctx.reply("NWC or Nostr Wallet Connect is standarized protocol allowing developers to create secure and non-custoidal lightning apps in standarized way. Connection usually works via conection link generated by user in his wallet.")
}
